...
def fmt_kzt(value) -> str:
    """Сумма с пробелами между тысячами: 3000000 → '3 000 000' (для промптов и консоли)."""
...
- Ориентир рыночного диапазона: от {fmt_kzt(price_min)} до {fmt_kzt(price_max)} тг.
...
- tech_stack — реалистичные технологии/платформы для этой категории."""
